...
// All Classes and Common methods related toselenium for web automation
...
public class WebCommons {
	...
	// Method to Click on the hidden Web element
	...
	// Method to enter the text into the text box field
	...
	// Method to select or de-select the checkbox
	...
	public void selectOption(WebElement dropdown, String selectBy, String option) {
		...
		if (selectBy.equalsIgnoreCase("visibleText")) {
			...
			s.selectByIndex(Integer.parseInt(option)); // index is int not String so, Data Type Casting is required
	...
	// Method to take Screen-Shot of window
	public static String takeWindowScreenshot(WebDriver driver, String screenshotNameAndFormat) throws IOException {

		String screenshotPath = System.getProperty("user.dir") + "/ScreenShots/" + screenshotNameAndFormat + ".png";
	...
	// Method to take Screen-Shot of element
	public static String takeElementScreenshot(WebElement element, String screenshotNameAndFormat) throws IOException {
	...
	// Method to get window handle id / ids
	...
	// Method to switch to specific window handle
